...
SECRET_KEY = "django-insecure-6h&6rzbf)jn!d3(9j_^swk7-7pgnmlw(2@$rj(-2y77_)5vx(q"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'portfolio_frontend/build')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'portfolio_frontend/build/static'),
]
